...
{/* Story Section */}
<div className="flex flex-col md:flex-row w-full items-stretch justify-around px-4 py-16 gap-8">
  {/* Left Section */}
  <div className="bg-[#2A254B] w-full md:w-1/2 h-[450px] text-white p-8 md:p-16 flex flex-col justify-between">
    <div>
    ...
    <button className="bg-[#F9F9F926] h-12 w-40 rounded-sm mt-10 text-white">
      View Collection
    </button>
  </div>
  {/* Right Section */}
