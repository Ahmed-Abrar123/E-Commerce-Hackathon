      ...
      <section>
        <div className="px-8 py-12">
          <div className="flex flex-col md:flex-row">
            ...
            {/* Right Section */}
            <div className="w-full md:w-[40%] h-auto md:h-[580px] bg-white flex justify-center items-center">
              <Image
                src={'/images/rightt.png'}
                width={600} /* Adjusted width */
                height={600} /* Adjusted height */
                alt="right"
                className="object-contain" /* Ensures the image scales proportionally */
              />
            </div>
          </div>
        </div>
